...
def main():
    ...
    #list
    global vislines, surfaces, linesa, visgeometries
    ...
    global all_points
    # Initialize a list to store all generated points
    all_points = []
